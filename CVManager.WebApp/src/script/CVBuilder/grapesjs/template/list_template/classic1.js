export const CLASSIC1 = {
    Name: 'Mẫu CV Cổ Điển 1',
    Label: `<img src="/content/image/mau-cv-classic-1.jpg" width="100%" alt="" class="block-label-img"><div class="block-label-title">Mẫu CV Cổ Điển 1</div>`,
    Content :`
    <div class="cvo-page container-fluid" style="padding: 15mm; font-size: 14px;">
        <div class="cvo-profile cvo-block" cvo-block-name="cvo-profile" style="padding: 3mm 4mm 7mm 4mm;">
            <div class="row">
                <div class="col-md-2">
                    <img src="https://cdn.pixabay.com/photo/2016/08/08/09/17/avatar-1577909_1280.png"
                        class="cvo-profile-avata" width="115" height="150"/> 
                </div>
                <div class="col-md-10 text-center">
                    <div class="cvo-profile-fullname"><h2>Nguyễn Văn A</h2></div>
                    <div class="cvo-wrapper d-flex justify-content-center">
                        <div class="cvo-label pr-3 font-weight-bold">Ngày sinh:</div>
                        <div class="cvo-profile-dob">21/02/1999</div>
                    </div>
                    <div class="cvo-wrapper d-flex justify-content-center">
                        <div class="cvo-label pr-3 font-weight-bold">Điện thoại:</div>
                        <div class="cvo-profile-phone">012345678</div>
                    </div>
                    <div class="cvo-wrapper d-flex justify-content-center">
                        <div class="cvo-label pr-3 font-weight-bold">Email:</div>
                        <div class="cvo-profile-email">abc@gmail.com</div>
                    </div>
                    <div class="cvo-wrapper d-flex justify-content-center">
                        <div class="cvo-label pr-3 font-weight-bold">Địa chỉ:</div>
                        <div class="cvo-profile-address">Số 1 Tạ Qunag Bửu</div>
                    </div>
                    <div class="cvo-wrapper d-flex justify-content-center">
                        <div class="cvo-label pr-3 font-weight-bold">Website:</div>
                        <div class="cvo-profile-website">facebook.com/abc</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cvo-award cvo-block" cvo-block-name="cvo-award" style="padding: 3mm 4mm 7mm 4mm;">
            ...
            <div class="cvo-award-table row">
                ...
                <div class="col-md-9">
                    <div class="row">
                        <div class="col-md-12 cvo-certification-title">Giải nhất cuộc thi MYCV</div>
                    </div>
                </div>
            </div>
        </div>
