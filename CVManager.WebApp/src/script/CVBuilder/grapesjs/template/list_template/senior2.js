export const SENIOR2 = {
    Name: 'Mẫu CV senior 2',
    Label: `<img src="/content/image/mau-cv-senior_2.jpg" width="100%" alt="" class="block-label-img"><div class="block-label-title">Mẫu CV Senior 2</div>`,
    Content :`
            ...
            <div class="cvo-profile row cvo-block" cvo-block-name="cvo-profile" style="padding: 3mm 4mm 7mm 4mm;">
                <div class="cvo-profile-fullname col-md-12 text-center"
                    style="
                    font-size: 15pt;
                    font-weight: 700;
                    color: #0e2452;">Nguyễn Văn A</div>
                <div class="col-md-12 cvo-profile-address text-center">
                    Số 1 Tạ Quang Bửu
                </div>
                <div class="col-md-12">
                    <div class="cvo-group d-flex justify-content-center">
                        <div class="cvo-group-item">
                            <svg style="vertical-align: baseline;" height="14" viewBox="0 0 58 58" width="14" xmlns="http://www.w3.org/2000/svg">
                            ...
                            </svg><span style="margin-left: 5px;" class="cvo-profile-phone">Số điện thoại</span>
                        </div>
                        <div class="cvo-group-item ml-4">
                            <svg style="vertical-align: baseline;" height="14" viewBox="0 0 58 58" width="14" xmlns="http://www.w3.org/2000/svg">
                                <g id="Page-1" fill="none" fill-rule="evenodd">
                                    <g id="003---Call" fill="rgb(0,0,0)" fill-rule="nonzero" transform="translate(-1)">
                                        <path id="Shape" d="m25.017 33.983c-5.536-5.536-6.786-11.072-7.068-13.29-.0787994-.6132828.1322481-1.2283144.571-1.664l4.48-4.478c.6590136-.6586066.7759629-1.685024.282-2.475l-7.133-11.076c-.5464837-.87475134-1.6685624-1.19045777-2.591-.729l-11.451 5.393c-.74594117.367308-1.18469338 1.15985405-1.1 1.987.6 5.7 3.085 19.712 16.855 33.483s27.78 16.255 33.483 16.855c.827146.0846934 1.619692-.3540588 1.987-1.1l5.393-11.451c.4597307-.9204474.146114-2.0395184-.725-2.587l-11.076-7.131c-.7895259-.4944789-1.8158967-.3783642-2.475.28l-4.478 4.48c-.4356856.4387519-1.0507172.6497994-1.664.571-2.218-.282-7.754-1.532-13.29-7.068z"/>
                            ...
                            </svg><span style="margin-left: 5px;" class="cvo-profile-email">Địa chỉ Email</span>
                        </div>
                        <div class="cvo-group-item ml-4">
                            <svg style="vertical-align: baseline;" height="14" viewBox="0 0 58 58" width="14" xmlns="http://www.w3.org/2000/svg">
                                <g id="Page-1" fill="none" fill-rule="evenodd">
                            ...
                            </svg><span style="margin-left: 5px;" class="cvo-profile-website">Facebook.com/1234</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="cvo-education cvo-block" cvo-block-name="cvo-education" style="padding: 3mm 4mm 7mm 4mm;">
                <div class="cvo-education-blocktitle text-center" style="font-size: 12pt; font-weight: 700;  margin-bottom: 10px;">HỌC VẤN</div>
                <div class="cvo-education-table row">
                    <div class="col-md-12 d-flex justify-content-between">
                        <div class="cvo-education-school font-weight-bold">Đại học MYCV</div>
            ...
            <div class="cvo-experience cvo-block" cvo-block-name="cvo-experience" style="padding: 3mm 4mm 7mm 4mm;">
                <div class="cvo-experience-blocktitle text-center" style="font-size: 12pt; font-weight: 700;  margin-bottom: 10px;">KINH NGHIỆM LÀM VIỆC</div>
            ...
            <div class="cvo-activity cvo-block" cvo-block-name="cvo-activity" style="padding: 3mm 4mm 7mm 4mm;">
                <div class="cvo-activity-blocktitle text-center" style="font-size: 12pt; font-weight: 700;  margin-bottom: 10px;">HOẠT ĐỘNG</div>
            ...
            <div class="cvo-certification cvo-block" cvo-block-name="cvo-certification" style="padding: 3mm 4mm 7mm 4mm;">
                <div class="cvo-certification-blocktitle text-center" style="font-size: 12pt; font-weight: 700;  margin-bottom: 10px;">CHỨNG CHỈ</div>
            ...
            <div class="cvo-award cvo-block" cvo-block-name="cvo-award" style="padding: 3mm 4mm 7mm 4mm;">
                <div class="cvo-award-blocktitle text-center" style="font-size: 12pt; font-weight: 700;  margin-bottom: 10px;">GIẢI THƯỞNG</div>
            ...
            <div class="cvo-skillgroup cvo-block" cvo-block-name="cvo-skillgroup" style="padding: 3mm 4mm 7mm 4mm;">
                <div class="cvo-skillgroup-blocktitle text-center" style="font-size: 12pt; font-weight: 700;  margin-bottom: 10px;">CÁC KỸ NĂNG</div>
            ...
            <div class="cvo-reference cvo-block" cvo-block-name="cvo-reference" style="padding: 3mm 4mm 7mm 4mm;">
                <div class="cvo-reference-blocktitle text-center" style="font-size: 12pt; font-weight: 700;  margin-bottom: 10px;">NGƯỜI THAM CHIẾU</div>
            ...
            <div class="cvo-project cvo-block" cvo-block-name="cvo-project" style="padding: 3mm 4mm 7mm 4mm;">
                <div class="cvo-project-blocktitle text-center" style="font-size: 12pt; font-weight: 700;  margin-bottom: 10px;">DỰ ÁN</div>
            ...
            <div class="cvo-additional-info cvo-block" cvo-block-name="cvo-additional-info" style="padding: 3mm 4mm 7mm 4mm;">
                <div class="cvo-additional-info-blocktitle text-center" style="font-size: 12pt; font-weight: 700;  margin-bottom: 10px;">THÔNG TIN THÊM</div>
            ...
            <div class="cvo-interests cvo-block" cvo-block-name="cvo-interests" style="padding: 3mm 4mm 7mm 4mm;">
                <div class="cvo-interests-blocktitle text-center" style="font-size: 12pt; font-weight: 700;  margin-bottom: 10px;">SỞ THÍCH</div>
