export const CLASSIC2 = {
    Name: 'Mẫu CV Cổ Điển 2',
    Label: `<img src="/content/image/mau-cv-classic-2.jpg" width="100%" alt="" class="block-label-img"><div class="block-label-title">Mẫu CV Cổ Điển 2</div>`,
    Content :`
        ...
        <div class="cvo-profile cvo-block" cvo-block-name="cvo-profile" style="padding: 3mm 4mm 7mm 4mm;">
            <div class="row">
                <div class="col-md-10" style="display: flex;flex-direction: column;">
                    ...
                    <div class="cvo-border-bottom" style="height: 3px; width: 100px; background-color: #000; margin: 10px 0;"></div>
                </div>
                <div class="col-md-2" style="display: flex;
                justify-content: flex-end;">
                    <img src="https://cdn.pixabay.com/photo/2016/08/08/09/17/avatar-1577909_1280.png"
                        class="cvo-profile-avata" width="90" height="90" style="border-radius: 50%;"/> 
                </div>
            </div>
            <div class="row"></div>
        </div>
        ...
        <div class="cvo-education cvo-block" cvo-block-name="cvo-education" style="padding: 3mm 4mm 7mm 4mm;">
            ...
            <div class="cvo-education-table row">
                ...
                <div class="col-md-1" style="display: flex; flex-direction: column;">
                    <div>&omicron;</div>
                    <div style="flex: 1; width: 1px; background-color: #ccc;margin-left: 4px;"></div>
                </div>
                <div class="col-md-8">
                    <div class="row">
